---
categories: Lang
date: 2020-01-16 14:38:48
description: 记录了我 2019.9-2020.1 在浙江大学上的《程序设计方法学》这门课的知识点。
tags: [Course, Java]
title: 《程序设计方法学》知识整理
updated: 2020-06-30
---

$2019.9 \sim 2020.1$ 上了永平奖获得者翁恺老师《程序设计方法学》这门课。这是一门很有趣的课，介绍了程序设计语言的历史和发展脉络。这门课有一半的时间是同学展示，我倒是更希望翁老师能多留出时间自己讲。

最终的期末考试内容为：BNF，数据类型和运算符，程序控制结构，流计算，递归，并行计算，函数的调用和返回，Actor，异步执行。所以我对他们做了一个简单的整理。
...
+   **Imperative languages** are abstractions of **von Neumann architecture**.
    ...
    ![](Principle-of-Programming-Language/memory.png)
+   Variable Attributes
    +   Name
    +   Value
    +   Type
...
+   分布式：并行的计算在不同的计算机上进行
    ...
    ![](Principle-of-Programming-Language/computation_graph.png)
...
+   ![](Principle-of-Programming-Language/stream.jpg)
