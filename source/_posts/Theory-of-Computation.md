...
description: 记录了我 2019.9-2020.1 在浙江大学上的《计算理论》这门课的知识点。
...
![](Theory-of-Computation/configuration.png)
...
+ **Example**：
    ![](Theory-of-Computation/tm_example.png)
...
+ **Multiple tapes Turing Machine**
	...
	- Example：2-tapes copy machine：
		![](Theory-of-Computation/2-tapes.png)
...
+ **Recursive**
	...
	- Example:  $L=\{a^{n} b^{n} c^{n}: n \geq 0\} .$ The Turing Machine shown below decides $L$.
		![](Theory-of-Computation/anbncn.png)
	- Definition: Let $f$ be a function $f: \Sigma_{0}^{\ast} \rightarrow \Sigma_{0}^{\ast}$ . $M$ **computes** function $f$ if $\forall w \in \Sigma_{0}^{\ast}, M(w)=f(w)$. 
	    ...
	    + Example: $succ(n)=n+1$. 
	    	![](Theory-of-Computation/succ.png)
	- Properties:
