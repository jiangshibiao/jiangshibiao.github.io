---
categories: CS
date: 2020-01-13 14:38:48
description: 记录了我 2019.9-2020.1 在浙江大学上的《计算机视觉》这门课的知识点。
tags: [Course, Vision]
title: 《计算机视觉》知识整理
updated: 2020-06-30
---

计算机视觉》考前知识点整理。参考：[这个网站](https://blog.csdn.net/Dango_miracle/article/details/79049104)。
...
+ Harris-Laplace: DoG: $D(x, y, \sigma) =(G(x, y, k \sigma)-G(x, y, \sigma)) \ast I(x, y) =L(x, y, k \sigma)-L(x, y, \sigma)$
    ![](Computer-Vision/DoG.png)
    ![](Computer-Vision/DoG_pic.png)

+ **SIFT描述子的计算**
  ![](Computer-Vision/SIFT.png)
    + Full Version
...
+ 链码用相邻边缘点组成的方向序列来表示边缘
    + 4-连通对应四方向链码
    + 8-连通对应八方向链码
    ![](Computer-Vision/chain_order.png)
...
+   **Triangulation**
    ![](Computer-Vision/Triangulation.png)
+   四个基本步骤
