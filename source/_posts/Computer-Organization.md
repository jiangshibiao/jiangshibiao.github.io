---
categories: CS
date: 2019-06-28 14:38:49
description: 记录了我 2019.3-2019.6 在浙江大学上的《计算机组成》这门课的知识点。
tags: [Course, System]
title: 《计算机组成》知识整理
updated: 2020-06-30
---
...
本门课程进一步熟悉了 MIPS 和 Verilog，最终还要在自己写的 CPU 上运行一个自己设计的程序。我写了一个迷你的 Flappy Bird 小游戏，链接 [见此](https://github.com/jiangshibiao/Flappy_bird)。本文对《计算机组成》的知识点进行了随性的整理。
...
多周期数据通路
![](Computer-Organization/4.png)

多周期状态机控制信号表
![](Computer-Organization/5.png)
...
- `page table` is indexed with the page number from the virtual address to discover physical address.
  ...
  ![](Computer-Organization/1.png)
  - TLB (Translation-lookaside Buffer)：
    ![](Computer-Organization/2.png)